    ...
    <div className="space-y-8">
      <section className="rounded-[2rem] border border-slate-200/80 bg-white/80 p-6 shadow-[0_24px_70px_-30px_rgba(15,23,42,0.25)] backdrop-blur">
        <div className="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
          <div>
            <p className="text-sm font-semibold uppercase tracking-[0.2em] text-amber-600">Admin control center</p>
          ...
          return (
            ...
            >
              <div className="flex items-start justify-between">
                ...
                <ArrowUpRight size={16} className="text-slate-300 group-hover:text-amber-600" />
              </div>
      ...
      <section className="rounded-[1.75rem] border border-slate-200/80 bg-white/90 p-5 shadow-[0_20px_45px_-25px_rgba(15,23,42,0.2)] sm:p-6">
        <div className="mb-5 flex items-center justify-between">
          <h3 className="font-display text-lg font-semibold text-slate-900">Recent courses</h3>
          <Link href="/admin/courses" className="text-sm font-semibold text-amber-700 hover:underline">
            View all
          </Link>
        </div>
        {loading ? (
